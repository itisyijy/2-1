...
fit_w
ks.test(my_data, "pweibull", scale=83.347679, shape=2.185885)
fit_ln
ks.test(my_data, "plnorm", 4.1693701, 0.5366095)
1-pkolmim(0.13966, 254)

fitdist(mydata, "norm")
fitdist(mydata, "lnorm")
fitdist(mydata, "exp")
fitdist(mydata, "pois")
fitdist(mydata, "cauchy")
fitdist(mydata, "gamma")
fitdist(mydata, "logis")
fitdist(mydata, "nbinom")
fitdist(mydata, "geom")
fitdist(mydata, "beta")
fitdist(mydata, "weibull")
...
install.packages("actuar")
library(actuar)
fitdist(mydata, "invgamma")
fitdist(mydata, "llogis")
fitdist(mydata, "invweibull")
fitdist(mydata, "pareto1")
fitdist(mydata, "pareto")
